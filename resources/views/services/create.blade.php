...
<div class="card-body">
    <form method="POST" action="{{ route('services.store') }}">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <input id="amount" type="number" class="form-control @error('amount') is-invalid @enderror" name="amount" min=0 step=0.01 value="{{ old('amount') }}" required autocomplete="amount" autofocus>
